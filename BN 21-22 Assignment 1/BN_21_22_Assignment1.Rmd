...
fit <- lavaan(sem_model1, sample.cov=polychoric, sample.nobs=nrow(d1_proc), auto.var=TRUE, data=d1_proc, conditional.x=FALSE, ordered=c( "cpk", "ejection_fraction","platelets" ,"srm_creatinine", "srm_sodium", "time"))
